...
class TechPatternBacktester():
    ...
    def __init__(self, symbol, start, end, tc, period = None, window = 1):
        self.symbol = symbol
        self.start = start
        self.end = end
        self.tc = tc
    ...
    def get_data(self):
        ...
        if self.period is not None:
            raw = yf.download(self.ticker, self.start, self.end, interval = self.period)
        else:
